...
if ($_SERVER["PHP_SELF"] == "/admin/live_ysf_log.php") {
...
<link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
    ...
    <title>Pi-Star - <?php echo $lang['digital_voice']." ".$lang['dashboard'];?> - YSFGateway Log</title>
    ...
    $(function() {
      $.repeat(1000, function() {
        $.get('/admin/live_ysf_log.php?ajax', function(data) {
  ...
  <body>
	  ...
	  <div class="header">
	      ...
	      <h1>Pi-Star <?php echo $lang['digital_voice'];?> - YSFGateway</h1>
	      <p>
		  <div class="navbar">
  ...
  <tr><th>Download the log: <a href="/admin/download_ysf_log.php" style="color: #ffffff;">here</a></th></tr>
  </table>
  </div>
  <div class="footer">
